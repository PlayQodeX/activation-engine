...
import {
  INSTANCES_DIR, COMMANDS_DIR, CMD_PREFIX, CMD_MARKER, INDEX_JSON, HELP_TEXT,
...
const META = {
  help: { desc: 'activation-engine: guide to every command (what / when)', static: true },
...
function metaBody(verb, m) {
  // Static command: the answer is embedded in the file itself — no script run,
  // no generation. The agent just relays the fenced block verbatim.
  if (m.static && verb === 'help') {
    return `---
description: "${m.desc}"
---
<!-- ${CMD_MARKER} ; meta:help ; DO NOT EDIT (regenerated by instance.mjs) -->

Output the following activation-engine command guide **exactly as written** — do
not summarise, reorder, add, or run anything. It is the complete, built-in answer.
